...
const ProductCard = ({ img, name, price, productID }: props) => {
    ...
    <div className="item w-60 bg-white p-4 inline-block mr-5 rounded-md shadow-xl">
      ...
      <div className="p-4">
        ...
        <div className="item-footer">
          {isCartProduct ? (
            <button className="px-5 py-2 border-2 border-orange-600 mt-3 rounded-3xl text-orange-600 hover:bg-orange-700 hover:text-white font-bold">
              Go to Cart
            </button>
          ) : (
            <button
              onClick={() => {
                onCartUpdate(productID);
              }}
